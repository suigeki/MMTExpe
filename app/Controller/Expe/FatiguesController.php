<?php
    ...
    class  FatiguesController extends AppController{   
        var $name='Fatigues';
        ...
        function write_data(){
            debug($this->request);
            $return = $this->MainFtn->ftn_write_data('fatigue', $this->request->data[0], $this->request->data['phase'], $this->request->data['user']);
            debug($return);
            $this->autoRender=false;
        }
